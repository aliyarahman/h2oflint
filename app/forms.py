...
class IndividualOfferForm(forms.Form):
    ...
    availability_start_date = forms.ChoiceField(choices = TIMES, required=False)
    availability_end_date = forms.ChoiceField(choices = TIMES, required=False)
    availability_start_month = forms.ChoiceField(choices = TIMES, required=False)
    availability_end_month = forms.ChoiceField(choices = TIMES, required=False)
